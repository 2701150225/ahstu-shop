	...
	<div class="topNav clearfix">
		<ul>
			...
			<li id="headerLogin" class="headerLogin" style="display: list-item;">
				...
				|</li>
			<li id="headerLogin" class="headerLogin" style="display: list-item;">
				<a href="${pageContext.request.contextPath}/order_findUid.action?page=1">我的订单</a>
			|</li>
			<li id="headerRegister" class="headerRegister"
...
<div class="span24">
	<ul class="mainNav">
		...
		<s:iterator var="c" value="#session.cList">
			<li><a href="${ pageContext.request.contextPath }/product_findCid.action?cid=<s:property value="#c.cid"/>&page=1"><s:property value="#c.cname"/></a> |</li>
		</s:iterator>
