...
<body>
					...
					<form id="registerForm"
						...
						<table>
							<tbody>
								...
								<tr>
									<th>&nbsp;</th>
									<td>
										<div id="agreement" class="agreement" style="height: 300px;">
						...
						<div class="login">
							...
							<dl>
								...
								<dd>
									立即登录即可体验在线购物！ <a
										href="http://localhost:8080/shop/user_loginPage.action">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © 2015-2018网上商城 版权所有</div>
		</div>
	</div>
	<div id="_my97DP"
